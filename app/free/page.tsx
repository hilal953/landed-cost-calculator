...
export default function FreeDashboard() {
  return (
    <>
      ...
      {/* PDF.js and Tesseract.js are lazy-loaded on demand in app.js */}
      <Script src="/app.js" strategy="afterInteractive" />
      

{/*  AESTHETIC FREE SUITE TOPBAR  */}
<header className="free-nav-header">
  <div className="free-nav-inner">
    ...
    <div className="free-nav-brand-group">
      ...
      <div className="free-nav-status">
        ...
        <span className="free-status-title">China Sea Cargo Active</span>
        <span className="free-status-sep">•</span>
        <span className="free-status-sub">RMB / USD to Local Currency</span>
      </div>
    </div>

    {/*  Right: Pro Upgrade & Home Link  */}
    <div className="free-nav-actions">
      <a href="https://built-by-aadil.lemonsqueezy.com/checkout/buy/b789412f-3a44-4c06-a3f6-4dc36eb391d8?logo=0" className="free-nav-pro-btn">
        <span>🚀</span>
      ...
      <div className="topbar-manifest">
        ...
        <div className="manifest-route-ribbon">
          ...
          <div className="route-transit">
            ...
            <span className="transit-badge">🚢 SEA</span>
            <span className="transit-line"></span>
          </div>
          <div className="route-station">
          ...
          <div className="rate-card">
            ...
            <div style={{"display":"flex","gap":"6px","alignItems":"center"}}>
              <div className="input-field" style={{"margin":"0","flex":"1"}}>
                ...
                <span className="input-suffix">/ CBM</span>
              </div>
            </div>
          </div>
    ...
    <section className="step-section" id="step4">
      ...
      <div className="summary-grid">
        <div className="summary-card">
          ...
          <div className="summary-value"><span id="sumCbm">0.00</span> <span className="summary-unit">CBM</span></div>
        </div>
        <div className="summary-card">
...
<div id="exportPaywallModal" style={{"display":"none","position":"fixed","inset":"0","background":"rgba(15, 23, 42, 0.75)","backdropFilter":"blur(10px)","WebkitBackdropFilter":"blur(10px)","zIndex":"99999","alignItems":"center","justifyContent":"center","padding":"20px","opacity":"0","transition":"opacity 0.3s ease"}}>
  <div className="paywall-modal-content" style={{"background":"#FFFFFF","borderRadius":"20px","width":"100%","maxWidth":"480px","padding":"36px 32px","boxShadow":"0 25px 50px -12px rgba(0,0,0,0.25)","textAlign":"center","border":"1px solid #E2E8F0","fontFamily":"'Inter', sans-serif","position":"relative","transform":"translateY(20px)","transition":"transform 0.3s cubic-bezier(0.16, 1, 0.3, 1)"}}>
    ...
    <h3 style={{"fontSize":"24px","fontWeight":"800","color":"#0F172A","marginBottom":"12px","letterSpacing":"-0.02em"}}>Unlock Premium Exports</h3>
    <p style={{"fontSize":"15px","color":"#475569","lineHeight":"1.6","marginBottom":"28px"}}>
      Sharing to WhatsApp, generating professional PDFs, and Excel exports are available in the <strong>Pro Version</strong>. Upgrade now to impress your clients and streamline your workflow forever.
    </p>
    ...
    <ul style={{"textAlign":"left","fontSize":"13.5px","color":"#64748B","margin":"0","padding":"0","listStyle":"none","display":"flex","flexDirection":"column","gap":"10px"}}>
      <li style={{"display":"flex","alignItems":"center","gap":"8px"}}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> Beautiful WhatsApp sharing
      </li>
      <li style={{"display":"flex","alignItems":"center","gap":"8px"}}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> Professional PDF printing
      </li>
      <li style={{"display":"flex","alignItems":"center","gap":"8px"}}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> Export Excel spreadsheets
      </li>
    </ul>
  </div>
</div>
